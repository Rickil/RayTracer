...
int main(){
    ...
    Camera camera(Point3(-3,-3,0.1), Point3(0,0,0.1), Vector3(0,0,1)
                  ,70,70);
    Point_Light* pointLight = new Point_Light(1, Point3(-2 ,-2 ,0));

    Camera camera2(Point3(3,3,0.1), Point3(0,0,0.1), Vector3(0,0,1)
            ,70,70);
