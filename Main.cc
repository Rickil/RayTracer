...
int main(){
    ...
    Sphere* sphere = new Sphere(uniformTexture, Point3(0.5,2.5,0), 0.5);
    Sphere* sphere2 = new Sphere(uniformTexture2, Point3(-0.5,3,0), 0.5);
    ...
    Camera camera(Point3(0,0,0), Point3(0,3,0), Vector3(0,0,1)
                  ,70,70);
    Point_Light* pointLight = new Point_Light(0.8, Point3(0 ,2 ,0));
    Scene scene(camera);
